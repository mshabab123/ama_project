...
public class errorCateg {

	private static String[][] alldataCatogCatog = new String[11264280][4];
	...
	public static void main(String[] args) throws IOException {
		...
		String filenameProdcut = "alldataCatogCatog";
		...
		for (int i = 0; i < CatogCatogSize; i++) {
			...
			finalresult[indCatog]= (float) (finalresult[indCatog]+ Math.pow( (rate-mean), 2));
	...
	static void WriteToFile() throws IOException {
		...
		File file = new File("result_differnceRCR");
